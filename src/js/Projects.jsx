                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div className="project-card-link-div">
                                    <a href="https://github.com/kgalip/sky-cast" target="_blank">Source</a>
                                    <a href="https://kgalip-skycast.netlify.app" target="_blank">Live</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div>
                                <div className="project-card-img-div">
                                    ...
                                    <img src={reactLogo} title="React" alt="React" width="45" height="45" />
                                    <img src={viteLogo} title="Vite" alt="Vite" width="45" height="45" />
                                </div>
                                <div className="project-card-link-div">
                                    <a href="https://github.com/kgalip/chat-on" target="_blank">Source</a>
                                    <a href="https://kgalip-chaton.netlify.app" target="_blank">Live</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div ref={projectThreeRef} className="project-card">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div className="project-card-link-div">
                                    <a href="https://github.com/kgalip/hair-couture" target="_blank">Source</a>
                                    <a href="https://kgalip-haircouture.netlify.app" target="_blank">Live</a>
                                </div>
                            </div>
                        </div>
                    </div>
